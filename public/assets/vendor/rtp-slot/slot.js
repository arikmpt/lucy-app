...
for (let i = 0; i <= text.length; i++) {
	...
	if (xx >= 30) {
		...
		if (xx > 70) {
			pola[i].style.backgroundColor = "#99ef19";
			jambg[i].style.backgroundColor = "#99ef19";
		} else {
			pola[i].style.backgroundColor = "#ff8900";
			jambg[i].style.backgroundColor = "#ff8900";
		}
	} else {
		jam[i].innerText = "-";
		pola[i].style.backgroundColor = "#fb1b31";
		jambg[i].style.backgroundColor = "#fb1b31";
